<?php
/**
 * UserSubmitsElementorForm.
 * php version 5.6
 *
 * @category UserSubmitsElementorForm
...
if ( ! class_exists( 'UserSubmitsElementorForm' ) ) :
	 ...
	 * @since    1.0.0
	 */
	class UserSubmitsElementorForm {
	...
	UserSubmitsElementorForm::get_instance();
