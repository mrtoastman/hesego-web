...
export declare class ScSessionProvider {
   ...
   * @param e
   */
  handleFormSubmit(): Promise<Checkout | NodeJS.Timeout>;
  /**
   * Handle paid event and update the
   */
  handlePaid(): Promise<void>;
  handlePayError(): Promise<void>;
  ...
  findOrCreateOrder(): Promise<void | NodeJS.Timeout | CustomEvent<{} | {
    message: string;
    code?: string;
    data?: any;
    additional_errors?: any;
  ...
  handleRedirectStatus(status: any, id: any): Promise<CustomEvent<{} | {
    message: string;
    code?: string;
    data?: any;
    additional_errors?: any;
  ...
  handleCheckoutIdFromUrl(id: any, promotion_code?: string): Promise<void | NodeJS.Timeout | CustomEvent<{} | {
    message: string;
    code?: string;
    data?: any;
    additional_errors?: any;
  ...
  addPriceChoices(line_items?: any[]): any[];
